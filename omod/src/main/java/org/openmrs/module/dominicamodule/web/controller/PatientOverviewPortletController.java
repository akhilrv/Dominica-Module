...
import org.openmrs.module.dominicamodule.NoteService;
...
//@RequestMapping(value = "/module/dominicamodule/addNote")
...
public class PatientOverviewPortletController{
	...
	public String showForm(){
            System.out.println("PatientOverviewPortletController GET method***************");
		return SUCCESS_FORM_VIEW;
	}
	
    /*
    public ModelAndView handleRequest1(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (patientIdStr == null) {
            patientIdStr = (String) request.getParameter("patient_id");
        }
        Integer patientId = Integer.valueOf(patientIdStr);
        System.out.println("PatientRegimensPortletController handleRequest1.. Patient Id: " + patientId);
        ...
        return new ModelAndView("/module/basicmodule/portlets/patientRegimens", map);
    }
*/
...
/*
        ...
        System.out.println("PatientOverviewPortletController addNote method   Title: " + 
...
*/
        // this goes to /openmrs/module/basicmodule/notes.form typically
